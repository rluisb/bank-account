...
class ControllerAdviceRequestError : ResponseEntityExceptionHandler() {
    ...
    fun handleInvalidDocumentException(
        ex: InvalidDocumentException,
        request: WebRequest
    ...
    fun handleDocumentAlreadyExistsException(
    ...
    fun handleInvalidValueForDepositException(
        ex: InvalidValueForDepositException,
        request: WebRequest
    ): ResponseEntity<ErrorsDetails> {
        val errorDetails = ErrorsDetails(
    ...
    fun handleInvalidValueForTransferException(
        ex: InvalidValueForTransferException,
        request: WebRequest
    ): ResponseEntity<ErrorsDetails> {
        val errorDetails = ErrorsDetails(
    ...
    @ExceptionHandler(value = [(InvalidTargetAccountForTransferException::class)])
    fun handleInvalidTargetAccountForTransferException(
        ex: InvalidTargetAccountForTransferException,
        request: WebRequest
    ): ResponseEntity<ErrorsDetails> {
        val errorDetails = ErrorsDetails(
            message = "Invalid target account for transfer",
            details = ex.message!!
        )
        return ResponseEntity(errorDetails, HttpStatus.UNPROCESSABLE_ENTITY)
    }
